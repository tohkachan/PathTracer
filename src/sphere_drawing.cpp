...
namespace tk
{
	...
	static void draw_sphere(const Vector3f& p, double r);
	...
	void draw_sphere(const Vector3f& p, double r) {
		if (!initialized) {
			init_mesh();
			initialized = true;
		}
